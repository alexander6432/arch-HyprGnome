...
return {
	...
	ansi = {
		...
		colors.surface_variant or "silver",
	},
	brights = {
		colors.outline or "grey",
		colors.tertiary_container or "red",
		colors.tertiary or "lime",
		colors.secondary_container or "yellow",
		colors.secondary or "blue",
		colors.primary_container or "fuchsia",
		colors.primary or "aqua",
		colors.on_surface or "white",
	},
